...
#include "/home/tatiana/Рабочий стол/sertificate-service/certify-tests/MyTestSuite.h"

static MyTestSuite suite_MyTestSuite;

static CxxTest::List Tests_MyTestSuite = { 0, 0 };
CxxTest::StaticSuiteDescription suiteDescription_MyTestSuite( "MyTestSuite.h", 15, "MyTestSuite", suite_MyTestSuite, Tests_MyTestSuite );
